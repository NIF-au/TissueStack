...
public class ConfigurationAction implements ClAction {
	...
	public String getUsage() {
		return "--ts-config list <== lists configuration table contents\n" +
			   "\t--ts-config query key <== displays a given configuration table value\n" +
			   "\t--ts-config change key value <== changes value for a configuration table entry";
	}
