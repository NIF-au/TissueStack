	...
	refresh: function( val, isfromControl, preventInputUpdate ) {
		...
		if ( typeof val === "object" ) {
			var data = val,
				...
				tol = 8;
			if ( !this.dragging ||
					data.pageY < this.slider.offset().top - tol ||
					data.pageY > this.slider.offset().top + this.slider.width() + tol ) {
				return;
			}
			percent = Math.round( ( ( data.pageY - this.slider.offset().top ) / this.slider.width() ) * 100 );
		} else {
			if ( val == null ) {
