...
TissueStack.PhoneMenu = function() {
		...
		$(function(){
			...
			$('.headers').on("swiperight", function(){
				if (!menuStatus){	
				$(".ui-page-active").animate({
					marginLeft: "165px",
				  }, 100, function(){menuStatus = true;});
 ...
 */
 ...
 /*!
  * Using iScroll to Provide Transition For TissueStack Phone Menu and DataSet Menu Touch Navigation
  * Clean up this library later in this project......
 */
